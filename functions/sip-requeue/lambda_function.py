...
def send_message(queue_url, group_id, dedup_id, message_body, message_attributes=None):
    """
...
def handle_record(record, queue_url, context):
    logger.info('## RECORD')
    logger.info(record)
    ...
    send_message(queue_url, group_id, dedup_id, rs)
...
def lambda_handler(event, context):
    ...
    for r in event['Records']:
        handle_record(r, sqs_target_url, context)
